    ...
    public class AccountCourseMappingProfile : Profile
    {
        public AccountCourseMappingProfile()
        {
            ...
            CreateMap<AccountCourse, GetListAccountCourseResponse>()
                ...
                .ForMember(dest => dest.PathFileCourse, opt => opt.MapFrom(src => src.Lesson.Course.PathFile.FileName))
                .ForMember(dest => dest.PathFileLesson, opt => opt.MapFrom(src => src.Lesson.PathFile.FileName))
