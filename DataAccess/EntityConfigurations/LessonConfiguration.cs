...
namespace DataAccess.EntityConfigurations
{
    public class LessonConfiguration : IEntityTypeConfiguration<Lesson>
    {
        public void Configure(EntityTypeBuilder<Lesson> builder)
        {
            ...
            builder.Property(l => l.ContentId).HasColumnName("ContentId");
            ...
            builder.Property(l => l.SessionRecordId).HasColumnName("SessionRecordId");
            builder.Property(l => l.InstructorId).HasColumnName("InstructorId");
            builder.Property(l => l.PathFileId).HasColumnName("PathFileId");
