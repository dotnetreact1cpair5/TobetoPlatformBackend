...
namespace WebApi.Controllers
{
    ...
    public class AccountApplicationController : ControllerBase
    {
        ...
        public AccountApplicationController(IAccountApplicationService accountApplicationService)
        {
        ...
        {
            var result = await _accountApplicationService.GetByUserId(userId);
            return Ok(result);
        }
