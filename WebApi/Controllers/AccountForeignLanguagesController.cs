...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    public class AccountForeignLanguagesController : ControllerBase
    {
        IAccountForeignLanguageService _accountForeignLanguageService;

        public AccountForeignLanguagesController(IAccountForeignLanguageService accountForeignLanguageService)
        {
